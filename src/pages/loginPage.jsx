            ...
            <div className="registerPage">
                <div className="areaForm">
                    <div className="form">
                        ...
                        <h2 style={{fontFamily: 'inter', fontSize: 20, color: 'rgb(136,132,132)', marginBottom: 40}}>Log into an Account</h2>
                        ...
                        <div style={{marginTop: 50}}>
                            <NavLink to='/home'><button className="accountB1">Sign in</button></NavLink>
                        </div>
                    </div>
                </div>
            </div>
